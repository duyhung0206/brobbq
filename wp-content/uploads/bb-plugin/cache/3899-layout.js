...
var wpAjaxUrl='https://brobbq.com/wp-admin/admin-ajax.php';var flBuilderUrl='https://brobbq.com/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://brobbq.com/wp-content/plugins/bb-plugin/',wpAjaxUrl:'https://brobbq.com/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5b03e79daf1a4',layout:'columns',pagination:'none',postSpacing:'20',postWidth:'300',matchHeight:1,isRTL:false});});})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5b02efd010777',layout:'columns',pagination:'none',postSpacing:'20',postWidth:'300',matchHeight:1,isRTL:false});});})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5b02f521196ad',layout:'columns',pagination:'none',postSpacing:'20',postWidth:'300',matchHeight:1,isRTL:false});});})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5b03d517ab5e1',layout:'columns',pagination:'none',postSpacing:'20',postWidth:'300',matchHeight:1,isRTL:false});});})(jQuery);