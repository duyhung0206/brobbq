<?php
if ( !class_exists( 'DPSP_PluginUpdateChecker' ) ):
...
* @access public
*/
class DPSP_PluginUpdateChecker {
	...
	function requestInfo($queryArgs = array()){
		...
		if ( !is_wp_error($result) && isset($result['response']['code']) && ($result['response']['code'] == 200) && !empty($result['body']) ){
			$pluginInfo = DPSP_PluginInfo::fromJson($result['body']);
		}
	...
	function requestUpdate(){
		...
		return DPSP_PluginUpdate::fromPluginInfo($pluginInfo);
	}
...
if ( !class_exists('DPSP_PluginInfo') ):
...
if ( !class_exists('DPSP_PluginUpdate') ):
...
class DPSP_PluginUpdate {
	...
	public static function fromJson($json){
		...
		$pluginInfo = DPSP_PluginInfo::fromJson($json);
		if ( $pluginInfo != null ) {
			return DPSP_PluginUpdate::fromPluginInfo($pluginInfo);
		} else {
			return null;
