<?php
	...
	add_action( 'admin_menu', 'dpsp_register_sticky_bar_subpage', 20 );


	/**
	 * Function that adds content to the sticky bar icons subpage
	 *
	 * @return string
	 *
	 */
	function dpsp_sticky_bar_subpage() {
		...
		include_once 'views/view-submenu-page-sticky-bar.php';
