...
!function (e) {
    ...
    e.exports = elementorFrontend.Module.extend({
        getElementName: function () {
            ...
            if (i) {
                var s = n.outerHeight() / n.outerWidth(), o = i.naturalHeight / i.naturalWidth;
            ...
            this.elements.$postsContainer.toggleClass(i.classes.hasItemRatio, !!n.match(/\d/)), t.isMasonryEnabled() || this.elements.$posts.each(function () {
                var n = e(this), s = n.find(i.selectors.postThumbnailImage);
                t.fitImage(n), s.on("load", function () {
                    t.fitImage(n)
                })
            })
        }, setColsCountSettings: function () {
            var e, t = elementorFrontend.getCurrentDeviceMode(), n = this.getElementSettings(),
    ...
    "use strict";
    var i = n(67).extend(), s = n(68);
    e.exports = function (e) {
        new i({$element: e}), new s({$element: e})
    }
}, function (e, t, n) {
    "use strict";
    var i = n(3);
    ...
    e.exports = elementorFrontend.Module.extend({
        getDefaultSettings: function () {
            return {
                selectors: {mainSwiper: ".elementor-main-swiper", swiperSlide: ".swiper-slide"},
                slidesPerView: {desktop: 3, tablet: 2, mobile: 1}
            }
        }, getDefaultElements: function () {
            var e = this.getSettings("selectors"), t = {$mainSwiper: this.$element.find(e.mainSwiper)};
            ...
            if (e.show_arrows && (t.navigation = {
                ...
                var n = {}, i = elementorFrontend.config.breakpoints;
                n[i.lg - 1] = {
            ...
            var n = t.match("space_between_(.*)"), i = n ? n[1] : "desktop", s = this.getSpaceBetween(i),
    ...
    i = s.extend({
        getDefaultSettings: function () {
            ...
            return e.slidesPerView = {desktop: 1, tablet: 1, mobile: 1}, e
        }, getEffect: function () {
            return "slide"
        }
    }), e.exports = function (e) {
    ...
    e.exports = elementorFrontend.Module.extend({
        getDefaultSettings: function () {
            ...
            var t = this, n = jQuery(e.currentTarget), i = n[0].files;
            if (i.length) {
                var s = 1024 * parseInt(n.attr("data-maxsize")) * 1024, o = n.attr("data-maxsize-message");
            ...
            n.append('<div class="elementor-message elementor-message-danger" role="alert">' + t + "</div>"), this.elements.$submitButton.html(this.elements.$submitButton.text()).removeAttr("disabled"), n.animate({opacity: "1"}, 100).removeClass("elementor-form-waiting"), n.trigger("error")
    ...
    e.exports = function (e) {
        ...
        if (t.length) {
            !function e(t) {
                ...
                !function (e) {
                    var t = grecaptcha.render(e[0], e.data()), n = e.parents("form");
    ...
    "use strict";
    var i = elementorFrontend.Module.extend({
        cache: null, cacheElements: function () {
            ...
            var e = this, t = this.getTimeRemaining(this.cache.data.endTime);
            jQuery.each(t.parts, function (t) {
                var n = e.cache.elements["$" + t + "Span"], i = this.toString();
            ...
            var t = e - new Date, n = Math.floor(t / 1e3 % 60), i = Math.floor(t / 1e3 / 60 % 60),
                s = Math.floor(t / 36e5 % 24), o = Math.floor(t / 864e5);
            return (o < 0 || s < 0 || i < 0) && (n = i = s = o = 0), {
                total: t,
                parts: {days: o, hours: s, minutes: i, seconds: n}
            }
        }, getEvergreenDate: function () {
            var e = this, t = this.cache.data.id, n = this.cache.data.evergreenInterval, i = t + "-evergreen_due_date",
                s = t + "-evergreen_interval",
                o = {dueDate: localStorage.getItem(i), interval: localStorage.getItem(s)}, r = function () {
                    var t = new Date;
    ...
    e.exports = i.extend({
        getElementName: function () {
            ...
            var i = this.getSettings(), s = this.elements.$postsContainer.width() / i.colsCount - t;
            return {
            ...
            var t = this.elements.$posts, n = this.getSettings("classes.active"), i = ".elementor-filter-" + e;
            ...
            for (var e = this.getSettings(), t = this.elements.$posts.filter(":visible"), n = this.elements.$postsContainer.find("." + e.classes.ghostItem), i = (e.colsCount - (t.length + n.length) % e.colsCount) % e.colsCount, s = 0; s < i; s++) this.elements.$postsContainer.append(jQuery("<div>", {class: e.classes.item + " " + e.classes.ghostItem}))
            ...
            var e = jQuery, t = this, n = t.getSettings(), i = t.elements.$posts.filter("." + n.classes.active),
                s = t.elements.$posts.not("." + n.classes.active), o = t.elements.$posts.filter(":visible"),
                r = i.add(o), a = i.filter(":visible"), l = i.filter(":hidden"), c = s.filter(":visible"),
                d = o.outerWidth(), u = o.outerHeight();
            ...
            c.css({opacity: 0, transform: "scale3d(0.2, 0.2, 1)"}), a.each(function () {
                var n = e(this), i = t.getOffset(r.index(n), d, u), s = t.getOffset(o.index(n), d, u);
                ...
                i.each(function () {
                    var s = e(this), o = t.getOffset(r.index(s), d, u), a = t.getOffset(i.index(s), d, u);
                    s.css({transitionDuration: n.transitionDuration + "ms"}), a.start -= o.start, a.top -= o.top, elementorFrontend.config.is_rtl && (a.start *= -1), setTimeout(function () {
            ...
            var t = this.getSettings("classes.active"), n = this.elements.$filterButtons,
    ...
    var i = elementorFrontend.Module.extend({
        getDefaultSettings: function () {
            return {
                selectors: {slider: ".elementor-slides", slideContent: ".elementor-slide-content"},
                classes: {animated: "animated"},
                attributes: {dataSliderOptions: "slider_options", dataAnimation: "animation"}
            }
        }, getDefaultElements: function () {
            var e = this.getSettings("selectors");
            return {$slider: this.$element.find(e.slider)}
        }, initSlider: function () {
            ...
            var e = this.elements.$slider, t = this.getSettings(), n = e.data(t.attributes.dataAnimation);
    ...
    i = s.extend({
        onInit: function () {
            ...
            var e = this.getElementSettings(), t = this.getSettings("classes"), n = e.share_url && e.share_url.url,
            ...
            return {
                selectors: {shareButton: ".elementor-share-btn", shareCounter: ".elementor-share-btn__counter"},
                classes: {shareLinkPrefix: "elementor-share-btn_", shareCounterPrefix: "elementor-share-btn__counter_"}
            }
        }, getDefaultElements: function () {
            var e = this.getSettings("selectors");
            return {$shareButton: this.$element.find(e.shareButton), $shareCounter: this.$element.find(e.shareCounter)}
        }
    }), e.exports = function (e) {
        new i({$element: e})
    }
    ...
    "use strict";
    var i = elementorFrontend.Module.extend({
        stretchElement: null, getDefaultSettings: function () {
            return {
                selectors: {
            ...
            var t = e[0].hash, n = jQuery(decodeURIComponent(t)), i = -300;
            if (n.length) {
                ...
                }, {offset: "50%", triggerOnce: !1}), elementorFrontend.waypoint(n, function (t) {
    ...
    var i = elementorFrontend.Module.extend({
        svgPaths: {
            ...
            this.elements.$dynamicText.each(function () {
                var t = jQuery(this), n = t.text().split(""), i = t.hasClass(e.textActive);
            ...
            var t = this, n = t.getSettings(), i = n.classes, s = "." + i.dynamicLetter,
            ...
            }, n.typeAnimationDelay); else if (t.elements.$headline.hasClass(i.letters)) {
            ...
            } else "clip" === o ? t.elements.$dynamicWrapper.animate({width: "2px"}, n.revealDuration, function () {
            ...
            if ("clip" === t) n.width(n.width() + 10); else if ("typing" !== t) {
                var i = 0;
            ...
            var t = this.svgPaths[e], n = jQuery();
            return t.forEach(function (e) {
                n = n.add(jQuery("<path>", {d: e}))
            }), n
        }, fillWords: function () {
            var e = this.getElementSettings(), t = this.getSettings("classes"), n = this.elements.$dynamicWrapper;
    ...
    e.exports = function () {
        ...
        elementorFrontend.hooks.addAction("frontend/element_ready/media-carousel-custom.default", n(85)), elementorFrontend.hooks.addAction("frontend/element_ready/testimonial-carousel.default", n(7)), elementorFrontend.hooks.addAction("frontend/element_ready/reviews.default", n(7))
    }
}, function (e, t, n) {
    "use strict";
    var i, s = n(6);
    i = s.extend({
        ...
        getDefaultElements: function () {
            var e = this.getSettings("selectors"), t = s.prototype.getDefaultElements.apply(this, arguments);
        ...
        onInit: function () {
            ...
            if (this.isSlideshow() && !(1 >= e)) {
                var t = this.getElementSettings(), n = "yes" === t.loop, i = {},
                    o = elementorFrontend.config.breakpoints, r = this.getDeviceSlidesPerView("desktop");
                i[o.lg - 1] = {
    ...
    var i = elementorFrontend.Module.extend({
        getDefaultSettings: function () {
            ...
            var e = this.elements.$container, t = this.elements.$closeButton, n = this.elements.$input,
                i = this.elements.$wrapper, s = this.elements.$icon, o = this.getElementSettings("skin"),
    ...
    var i = elementorFrontend.Module.extend({
        getDefaultSettings: function () {
            ...
            var e = this.elements.$container, t = this.elements.$closeButton, n = this.getSettings("classes");
    ...
    e.exports = function () {
        var e = n(97);
        this.dynamicTags = {lightbox: new e}
    }
}, function (e, t, n) {
    "use strict";
    var i = elementorFrontend.Module.__super__.constructor.extend({
        selectors: {lightbox: 'a[href^="!#elementor-lightbox|"]'},
        bindEvents: function () {
...
var sections = jQuery('.elementor-menu-anchor')
    , nav = jQuery('.table-of-content .btn-href-level-1')
    , nav_height = nav.outerHeight();

function detectScrollTo(element){
    var cur_pos = jQuery(element).scrollTop();

    sections.each(function (index, element) {
        var top = jQuery(element).offset().top;
        if (cur_pos >= (top - 150)) {
            tableOfContent.setAttribute("style", "display: block");
            if (index + 1 < sections.length) {
                bottom = jQuery(sections[index + 1]).offset().top;
                if (cur_pos <= (bottom - 150)) {
                    let tagA = nav.find('a.active');
                    let currentActive = nav.find('a.active')[0];
                    let currentNeedActive = nav.find('a[href$="#' + jQuery(element).attr('id') + '"]');
                    if (tagA.length > 0) {
                        if (currentActive.hash != "#" + jQuery(element).attr('id')) {
                            nav.find('a').removeClass('active');
                            currentNeedActive.addClass('active');
                            tableOfContent.scrollLeft = nav.find('a[href$="#' + jQuery(element).attr('id') + '"]').parent().parent().parent().offset().left;
                        }
                    } else {
                        currentNeedActive.addClass('active');
                        tableOfContent.scrollLeft = nav.find('a[href$="#' + jQuery(element).attr('id') + '"]').parent().parent().parent().offset().left;
        ...
        if (index == 0 && cur_pos < (top - 150)) {
            nav.find('a').removeClass('active');
            sections.removeClass('active');
            if (window.innerWidth <= 1024) {
                tableOfContent.setAttribute("style", "display: none");
            }
        }
    });
}
...
jQuery(window).load(function () {
    detectScrollTo(this);
    let tables = jQuery('.table-feature table');
    tables.each(function (index, table) {
        let data = [];
        jQuery(table).addClass('large-only');
        let thThead = jQuery(table).find('thead tr th');
        let dataThThead = [];
        thThead.each(function (indexTh, th) {
            dataThThead.push(th.innerText);
        })
        data.push(dataThThead);


        let trTbody = jQuery(table).find('tbody tr');
        trTbody.each(function (indexTr, tr) {
            let dataTdTbody = [];
            jQuery(tr).find('td').each(function (indexTd, td) {
                dataTdTbody.push(td.innerText);
            });
            data.push(dataTdTbody);
        })
        ...
        for (j = 1; j < data[0].length; j++) {
            for (i = 0; i < data.length; i++) {
                dataConvert.push([data[i][0], data[i][j]]);
            }
        }

        let tableHtml = "<table class='tablesorter eael-data-table center small-only'><tbody>";
        dataConvert.forEach(function (dataC) {
            let trHtml = "";
            if (dataC[0] == data[0][0]) {
                trHtml = "<tr><td colspan='2'>" + dataC[1] + "</td></tr>";
            } else {
                trHtml = "<tr><td>" + dataC[0] + "</td>" + "<td>" + dataC[1] + "</td></tr>";
            }
            tableHtml += trHtml;
        });
        tableHtml += "</tbody></table>";
        jQuery(table).after(tableHtml);
    });
})
