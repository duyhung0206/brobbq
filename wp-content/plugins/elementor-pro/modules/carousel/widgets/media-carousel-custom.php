...
class Media_Carousel_Custom extends Base
{
    ...
    {
        return 'media-carousel-custom';
    }

    public function get_title()
    {
        return __('Media Carousel Custom', 'elementor-pro');
    }

    public function get_icon()
    {
        return 'eicon-media-carousel-custom';
    }
    ...
    protected function add_repeater_controls(Repeater $repeater)
    {
        ...
        $repeater->add_control(
            'summary',
            [
                'label' => __('Summary', 'elementor-pro'),
                'type' => Controls_Manager::TEXT,
            ]
        );
        $repeater->add_control(
        ...
        $repeater->add_control(
            'review-to',
            [
                'label' => __('Review to', 'elementor-pro'),
                'type' => Controls_Manager::TEXT,
            ]
        );
    }
